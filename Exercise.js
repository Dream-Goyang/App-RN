 ...
 return (
   <SafeAreaView style={{flex:1, alignItems:'center', justifyContent:'flex-start',}}>
    ...
    <View style={{alignItems:'space-around', flexDirection: 'row'}}>
      ...
      <TouchableOpacity style={{paddingBottom:15,paddingRight:10}} onPress={()=>navigation.navigate("걸어갈고양")}>     
        <Image source={require('../../assets/HomeIcon.png')} style={imageStyles.HomeIcon}/>
      </TouchableOpacity>
